...
export const LAMBDA_ENDPOINTS = {
  ...
  COURSES: process.env.REACT_APP_COURSES_LAMBDA_URL || 'https://bqzuf5lilg.execute-api.us-east-2.amazonaws.com/Prod',
  ...
  SEARCH: process.env.REACT_APP_SEARCH_LAMBDA_URL || 'https://bqzuf5lilg.execute-api.us-east-2.amazonaws.com/Prod'
};
